...
function createTicket() {
  ...
  client.iparams.get("freshdesk_subdomain").then(
    function (iparams) {
      client.request.post(`https://${iparams.freshdesk_subdomain}.freshdesk.com/api/v2/tickets`,
        {
          headers: {
      ...
      document.getElementById('newTicketBanner').value = `Freshdesk talks in tickets, check for new ticket.`;
      }, error => {
